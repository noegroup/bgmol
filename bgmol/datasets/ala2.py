...
class Ala2Implicit300(DataSet):
    ...
    """
    url = "ftp://ftp.mi.fu-berlin.de/pub/cmb-data/bgmol/Ala2Implicit300.tgz"
...
class Ala2Implicit1000(DataSet):
    ...
    output spaced in 10 ps intervals.
    """
    url = "ftp://ftp.mi.fu-berlin.de/pub/cmb-data/bgmol/Ala2Implicit1000.tgz"
...
class Ala2TSF300(DataSet):
    ...
    """
    url = "ftp://ftp.mi.fu-berlin.de/pub/cmb-data/bgmol/ala2/Ala2TSF300.tgz"
...
class Ala2TSF600(DataSet):
    ...
    """
    url = "ftp://ftp.mi.fu-berlin.de/pub/cmb-data/bgmol/ala2/Ala2TSF600.tgz"
...
class Ala2TSF1000(DataSet):
    ...
    output spaced in 20 fs intervals.
    """
    url = "ftp://ftp.mi.fu-berlin.de/pub/cmb-data/bgmol/ala2/Ala2TSF1000.tgz"
