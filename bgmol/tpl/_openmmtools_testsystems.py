"""
THIS FILE IS AN ALMOST VERBATIM COPY OF THE TESTSYSTEMS MODULE IN OPENMMTOOLS (13 May 2020)
The only changes:
 - kB is defined directly, not imported from openmmtools.constants
 - the data path is modified to point to "_openmmtools_data/" (global replace "data/" by "_openmmtools_data/")
 - in get_data_filename point to a different resource_filename
...
def get_data_filename(relative_path):
    ...
    fn = resource_filename('bgmol.tpl._openmmtools_testsystems', relative_path)
...
class AlanineDipeptideVacuum(TestSystem):
    ...
    def __init__(self, constraints=app.HBonds, hydrogenMass=None, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/alanine-dipeptide-gbsa/alanine-dipeptide.prmtop")
        crd_filename = get_data_filename("_openmmtools_data/alanine-dipeptide-gbsa/alanine-dipeptide.crd")
...
class TolueneVacuum(TestSystem):
    ...
    def __init__(self, constraints=app.HBonds, hydrogenMass=None, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/benzene-toluene-implicit/solvent.prmtop")
        inpcrd_filename = get_data_filename("_openmmtools_data/benzene-toluene-implicit/solvent.inpcrd")
...
class _HostGuestBase(object):
    ...
    def host_oemol(self):
        ...
        return _read_oemol("_openmmtools_data/cb7-b2/cb7_tripos.mol2")

    @property
    def guest_oemol(self):
        """OpenEye ``OEMol`` for the guest."""
        return _read_oemol("_openmmtools_data/cb7-b2/b2_tripos.mol2")
...
class HostGuestVacuum(TestSystem, _HostGuestBase):
    ...
    def __init__(self, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/cb7-b2/complex-vacuum.prmtop")
        crd_filename = get_data_filename("_openmmtools_data/cb7-b2/complex-vacuum.inpcrd")
...
class HostGuestExplicit(TestSystem, _HostGuestBase):
    ...
    def __init__(self, rigid_water=True, use_dispersion_correction=True, switch_width=DEFAULT_SWITCH_WIDTH, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/cb7-b2/complex-explicit.prmtop")
        crd_filename = get_data_filename("_openmmtools_data/cb7-b2/complex-explicit.inpcrd")
...
class DHFRExplicit(TestSystem):
    ...
    def __init__(self, constraints=app.HBonds, rigid_water=True, nonbondedCutoff=DEFAULT_CUTOFF_DISTANCE, use_dispersion_correction=True, nonbondedMethod=app.PME, hydrogenMass=None, switch_width=DEFAULT_SWITCH_WIDTH, ewaldErrorTolerance=DEFAULT_EWALD_ERROR_TOLERANCE, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/dhfr/prmtop")
        crd_filename = get_data_filename("_openmmtools_data/dhfr/inpcrd")
...
class DNADodecamerExplicit(TestSystem):
    ...
    def __init__(self, constraints=app.HBonds, rigid_water=True, nonbondedCutoff=DEFAULT_CUTOFF_DISTANCE,
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/dna_dodecamer_explicit/prmtop")
        pdbfile_name = get_data_filename('_openmmtools_data/dna_dodecamer_explicit/minimized_dna_dodecamer.pdb')
...
class LysozymeImplicit(TestSystem):
    ...
    def __init__(self, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/T4-lysozyme-L99A-implicit/complex.prmtop")
        crd_filename = get_data_filename("_openmmtools_data/T4-lysozyme-L99A-implicit/complex.crd")
...
class SrcImplicit(TestSystem):
    ...
    def __init__(self, **kwargs):
        ...
        pdb_filename = get_data_filename("_openmmtools_data/src-implicit/1yi6-minimized.pdb")
...
class SrcExplicit(TestSystem):
    ...
    def __init__(self, nonbondedMethod=app.PME, nonbondedCutoff=DEFAULT_CUTOFF_DISTANCE, switch_width=DEFAULT_SWITCH_WIDTH, ewaldErrorTolerance=DEFAULT_EWALD_ERROR_TOLERANCE, use_dispersion_correction=True, **kwargs):
        ...
        pdb_filename = get_data_filename("_openmmtools_data/src-explicit/1yi6-minimized.pdb")
        pdbfile = app.PDBFile(pdb_filename)
...
class MethanolBox(TestSystem):
    ...
    def __init__(self, constraints=app.HBonds, nonbondedCutoff=7.0 * unit.angstroms, nonbondedMethod=app.CutoffPeriodic, **kwargs):
        ...
        prmtop_filename = get_data_filename("_openmmtools_data/%s/%s.prmtop" % (system_name, system_name))
        crd_filename = get_data_filename("_openmmtools_data/%s/%s.crd" % (system_name, system_name))
...
class AMOEBAIonBox(TestSystem):
    ...
    def __init__(self, **kwargs):
        ...
        pdb_filename = get_data_filename("_openmmtools_data/amoeba/ion-in-water.pdb")
        pdbfile = app.PDBFile(pdb_filename)
...
class AMOEBAProteinBox(TestSystem):
    ...
    def __init__(self, **kwargs):
        ...
        pdb_filename = get_data_filename("_openmmtools_data/amoeba/1AP4_14_wat.pdb")
        pdbfile = app.PDBFile(pdb_filename)
